...
public class NameInputNull {
	
	WebDriver driver = Login.driver;
	
	@Test(dataProvider="nameInputNull",dataProviderClass = Agent_AuthInfo_GetData.class)
	public void nameInputNull(String caseName,Map<String, String> map) {
