...
public class AgentRent_xiajia {

	public static void rent_xiajia_free(WebDriver driver){
		driver.get("https://agent.izhiliao.com/ucenter/index");
		driver.findElement(By.xpath("/html/body/div[4]/div[1]/ul/li[3]/div")).click();
		driver.findElement(By.xpath("/html/body/div[4]/div[1]/ul/li[3]/ul/li[2]/a")).click();
